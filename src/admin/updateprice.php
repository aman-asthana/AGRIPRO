...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <script>
          ...
          <li><a class="nav-link scrollto" href="adminindex.php#hero">Home</a></li>
          <li><a class="nav-link scrollto" href="adminindex.php#price">Price</a></li>
          ...
          <li><a class="nav-link scrollto active" href="updateprice.php">Update Price</a></li>
          ...
          <!-- <li><a class="nav-link scrollto" href="#doctors"></a></li>
           -->
          <li><a class="nav-link scrollto" href="adminindex.php#contact">Contact</a></li>
        </ul>
                      ...
                      if(isset($_POST))
                      {
                          ...
                          $query_run = mysqli_query($con, $query);
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="../../codes/pricecode.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <label>Wheat</label>
                                        <input type="text" name="wheat" value="<?=$product['wheat'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Soyabean</label>
                                        <input type="text" name="soyabean" value="<?=$product['soyabean'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Toor</label>
                                        <input type="text" name="toor" value="<?=$product['toor'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Chana</label>
                                        <input type="text" name="chana" value="<?=$product['chana'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Chana (V2)</label>
                                        <input type="text" name="chanav2" value="<?=$product['chanav2'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Cotton</label>
                                        <input type="text" name="cotton" value="<?=$product['cotton'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
      ...
      <div class="container text-center text-md-start mt-5">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="../views/onlyviewproduct.php" class="text-dark">Product</a>
            </p>
            <p>
              <a href="../views/onlyviewnews.php" class="text-dark">News</a>
            </p>
