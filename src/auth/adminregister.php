...
if (isset($_POST['submit'])) {
	...
	if ($count > 0) {
		...
		$insert_sql = "INSERT INTO adminreg (name,email,phone,password) VALUES('$name','$email','$contact','$secure_pwd')";
				...
				<div class="card shadow-lg alert alert-success">
					...
					<div class="card-body p-5">
						...
						<form method="POST" class="needs-validation" novalidate="" autocomplete="off">
							...
							<div class="mb-3">
								<label class="mb-2 text-muted" for="name">Contact no</label>
								<input id="name" type="text" class="form-control" name="contact" value="" required autofocus>
								<div class="invalid-feedback">
					...
					<div class="card-footer py-3 border-0 bg-light">
						<div class="text-center">
							Already have an account? <a href="adminlogin.php" class="text-dark">Login</a>
						</div>
					</div>
				</div>
