      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        ...
        <li class="dropdown">My Profile<i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li class="mr-5"><div class="d-flex align-item-center"><button type="button" class="btn btn-danger" onclick="showConfirmation()">Logout</button> <h2>&crarr;</h2></div>
      <script>
                    ...
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="codes/newscode.php" method="POST">
                                    <input type="hidden" name="news_id" value="<?= $new['id']; ?>">

                                    <div class="mb-3">
                                        <label>News Content</label>
                                        <input type="text" name="newsc" value="<?=$new['newsc'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Date</label>
                                        <input type="text" name="date" value="<?=$new['date'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>News Type</label>
                                        <input type="text" name="ntype" value="<?=$new['ntype'];?>" class="form-control">
                                    </div>
