                    ...
                    <div class="card-body">
                        <form action="codes/newscode.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="newsc" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>Date</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="ntype" class="form-control">
                            </div>
                           
                            <div class="mb-3">
                                <button type="submit" name="save_news" class="btn btn-success">Add News</button>
                            </div>
