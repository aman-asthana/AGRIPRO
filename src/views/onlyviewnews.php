...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <script>
          ...
          <li><a class="nav-link scrollto active" href="onlyviewnews.php">Latest News</a></li>
          <li><a class="nav-link scrollto" href="../admin/updateprice.php">Update Price</a></li>
          <li><a class="nav-link scrollto" href="newsinfo.php">Add News</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>News Details
                            <!-- <a href="addnews.php" class="btn btn-primary float-end">Add News</a> -->
                        </h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $new)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="viewnews.php?id=<?= $new['id']; ?>" class="btn btn-info btn-sm">View</a>
