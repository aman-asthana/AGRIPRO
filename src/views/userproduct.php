...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <script>
          ...
          <li><a class="nav-link scrollto active" href="userproduct.php">Product</a></li>
          <li><a class="nav-link scrollto" href="usernews.php">Latest News</a></li>
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $product)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="userviewproduct.php?id=<?= $product['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <!-- <a href="editproduct.php?id=<?= $product['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="codes/code.php" method="POST" class="d-inline">
