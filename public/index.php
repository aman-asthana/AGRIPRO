<?php
require_once __DIR__ . '/../src/config/connection.inc.php';
...
$sql = "SELECT * FROM price ORDER BY date DESC LIMIT 1";
...
// Get previous day's data for comparison (if needed)
$sql2 = "SELECT * FROM price ORDER BY date DESC LIMIT 1, 1";
$result2 = mysqli_query($conn, $sql2);
$row2 = mysqli_fetch_assoc($result2);

// If no previous data found, use same as current
if (!$row2) {
    $row2 = [
        'wheat' => 'Previous: N/A',
        'soyabean' => 'Previous: N/A',
        'toor' => 'Previous: N/A',
        'chana' => 'Previous: N/A',
        'chanav2' => 'Previous: N/A',
        'cotton' => 'Previous: N/A'
    ];
}
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.php"><img src="../assets/img/logo.jpg" width="80px" height="80px"></a></h1>
        ...
        <li class="dropdown">My Profile<i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><form class="d-flex">
                <h6 class="container mt-2">Hello! <?php echo $_SESSION['USER_NAME']; ?></h6>
                </form></li>
      ...
      <script>
          ...
          <li><a class="nav-link scrollto" href="index.php#price">Price</a></li>
          <li><a class="nav-link scrollto" href="../src/views/userproduct.php">Product</a></li>
          <li><a class="nav-link scrollto" href="../src/views/usernews.php">Latest News</a></li>
      ...
      <div class="section-title">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <span class="fas fa-inr"><?php echo $row['wheat'] ?></span><br>
          ...
          <div class="col-lg-4 col-md-6 mt-5 mt-md-0">
            <div class="count-box">
              <i class="fa fa-inr"></i><br>
              <span class="fa fa-inr "><?php echo $row['soyabean'] ?></span><br>
          ...
          <div class="col-lg-4 col-md-6 mt-5 mt-lg-0">
            <div class="count-box">
              <i class="fa fa-inr"></i><br>
              <span class="fa fa-inr "><?php echo $row['toor'] ?></span><br>
          ...
          <div class="col-lg-4 col-md-6 mt-5 mt-lg-10">
            <div class="count-box">
              <i class="fas fa-inr"></i><br>
              <span class="fa fa-inr "><?php echo $row['chana'] ?></span><br>
          ...
          <div class="col-lg-4 col-md-6 mt-5 mt-lg-50">
            <div class="count-box">
              <i class="fas fa-inr"></i><br>
              <span class="fa fa-inr "><?php echo $row['chanav2'] ?></span><br>
          ...
          <div class="col-lg-4 col-md-6 mt-5 mt-lg-10">
            <div class="count-box">
              <i class="fas fa-inr"></i><br>
              <span class="fa fa-inr "><?php echo $row['cotton'] ?></span><br>
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-4">
            <div class="info">
              ...
              <div class="email">
               <i class="bi bi-envelope" style = "background-color: #5cf368"></i>
                <h4>Email:</h4>
                <p>agriiinfo00@gmail.com</p>
              </div>

              <div class="phone" >
                <i class="bi bi-phone" style = "background-color: #5cf368"></i>
                <h4>Call:</h4>
                <p>+91 9359539232</p>
              </div>
  ...
  <!-- ======= Footer ======= -->
   ...
   <footer
      ...
      <div class="container text-center text-md-start">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <hr class="mb-4 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: #7c4dff; height: 2px"/>
            <p>
              <a href="index.php#price" class="text-dark">Price</a>
            </p>
            <p>
              <a href="../src/views/userproduct.php" class="text-dark">Product</a>
            </p>
            <p>
              <a href="../src/views/usernews.php" class="text-dark">News</a>
            </p>
    ...
    <div
      ...
      <p><a href="../src/auth/adminlogin.php" style="font-color: black;" target="_blank" class="text-dark">ADMIN LOGIN</a></p>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer --><!-- End Footer -->
